...
export class MessageApi extends BaseLoopBackApi {
   ...
   *  - `res` – `{object}` - 
   */
  public sendMessage(messageData: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof messageData !== 'undefined' && messageData !== null) _urlParams.messageData = messageData;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
